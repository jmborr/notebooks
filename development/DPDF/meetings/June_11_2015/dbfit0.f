      ...
      DIMENSION X1(Nsz),Y1(Nsz),SIG1(Nsz), Y3(Nsz)      
      character*80 arg(10)
      character*80 fplot
      EXTERNAL FJC
      fplot='~/bin/fplot'
      n_fit=0
 1    write(6,*)' dbfit0 f_name Qmin Qmax p1 p2 p3'
      n_g=iargc()
      if(n_g.lt.6) then 
         write(6,*) 'Missing argument'
         stop
      endif
      do i=1,n_g
         call getarg(i,arg(i))
...
D	write(6,*)' Qmin and Qmax for fitting:',x(1),x(ndata)         
 ...
 100  ALAMDA=0
	...
	write(6,*)' parameter',i,a(i)
      ...
      write(fhistry,'(i2,4(1x,e14.6))')n_fit,(a(i),i=1,ma), 0.0
c      write(2,'(i5,3(2x,f6.2),2x,i2,2x,i2)') ndata,0.5,1.0,12.0,1,1
	 ...
	 y1(i)=yfit
      ...
      close(12)
      write(fname,'(a,a4)')filename(:lench(filename)),'FIT0'
      write(6,*)fname
